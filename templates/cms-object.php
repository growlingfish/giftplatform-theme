...
<div class="step" id="step1">
    ...
    <ol>
        <li style="list-style-type: numeric !important;">Give the object a name (in the box labelled "Enter title here")</li>
        <li style="list-style-type: numeric !important;">Give the object a brief description in the larger box below</li>
        <li style="list-style-type: numeric !important;">Be sure to choose <strong>your username</strong> as the owner</li>
        <li style="list-style-type: numeric !important;">Search the list of locations and choose yours <?php echo (isset ($location) ? '('.$location->post_title.')' : '' ); ?></li>
    ...
    <p><a href="https://platform.gifting.digital/wp/wp-admin/post-new.php?post_type=object" class="button" target="_blank">Open the CMS</a></p>
</div>
