...
<div class="step" id="step1">
    ...
    <ol>
        <li style="list-style-type: numeric !important;">Give the location a name (in the box labelled "Enter title here")</li>
        <li style="list-style-type: numeric !important;">Give the location a brief description in the larger box below</li>
