...
<div class="step" id="step1">
    ...
    <ol>
        <li>Give the location a name (in the box labelled "Enter title here")</li>
        <li>Give the location a brief description in the larger box below</li>
        <li>Start typing the name of your venue <?php echo (isset ($venue) ? '('.$venue->name.')' : '' ); ?> into the box labelled "Venues"; when your venue appears, "add" it</li>
    </ol>
